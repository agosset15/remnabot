...
msg-menu-invite =
    ...
    За каждую оплату приглашенного пользователя вы получите:
    <blockquote>
    1. +1% к вашей постоянной скидке
    2. 30% скидку на следующую покупку
    </blockquote>

    <b>📊 Статистика:</b>
    <blockquote>
    👀 Переходов по вашей ссылке: { $referral_count }
    💳 Покупок ваших друзей: { $referral_payments }
    💸 Ваша скидка: { $referral_earned }%
    </blockquote>
