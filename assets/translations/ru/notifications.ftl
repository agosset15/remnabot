...
ntf-requirement =
    ...
    .channel-join-error = ⚠️ <i>Мы не видим вашу подписку на канал. Проверьте подписку и попробуйте снова.</i>
...
ntf-user =
    ...
    .message-sent = ✅ <i>Сообщение успешно отправлено.</i>
    .message-failed = ❌ <i>Не удалось отправить сообщение.</i>

    .sync-already-updated = ✅ <i>Данные подписки уже синхронизированы.</i>
...
ntf-importer =
    ...
    .db-invalid = ❌ <i>Этот файл не может быть импортирован.</i>
    .db-failed = ❌ <i>Ошибка при импорте базы данных.</i>
    .exported-users-empty = ❌ <i>Список пользователей в базе данных пуст.</i>
