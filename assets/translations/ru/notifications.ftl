...
ntf-event-user-expired =
    ...
    *[TRUE] Ваш бесплатный пробный период закончился. Оформите подписку, чтобы продолжить пользоваться сервисом!
    }
...
ntf-event-user-expired-ago =
    ...
    *[TRUE] Ваш бесплатный пробный период закончился { unit-day } назад. Оформите подписку, чтобы продолжить пользоваться сервисом!
    }
...
ntf-referral-payout = <b>💸 Ваш друг совершил покупку, ваша скидка увеличена!</b>
