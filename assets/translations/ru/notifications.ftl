...
ntf-user =
    ...
    .password-reset-success = ✅ <i>Пароль пользователя обновлён. Активные сессии завершены.</i>
    .password-reset-invalid = ❌ <i>Пароль должен быть от 8 до 256 символов.</i>
    .password-reset-no-email = ❌ <i>У пользователя не задана почта — пароль не используется.</i>
