...
ntf-user-plans-empty = <i>❌ Нет доступных тарифов для выдачи.</i>
ntf-user-devices-empty = <i>❌ Список устройств пуст.</i>
ntf-user-invalid-number = <i>❌ Некорректное число.</i>
ntf-user-allowed-plans-empty = <i>❌ Нет доступных тарифов для предоставления доступа.</i>
...
ntf-plan-trial-once-duration = <i>❌ Пробный тариф может иметь только одну длительность.</i>
ntf-plan-trial-already-exists = <i>❌ Пробный тариф уже существует.</i>
...
ntf-plan-save-error = <i>❌ Ошибка сохранения тарифа.</i>
ntf-plan-name-already-exists = <i>❌ Тариф с таким именем уже существует.</i>
...
ntf-plan-updated-success = <i>✅ Тариф успешно обновлен.</i>
ntf-plan-created-success = <i>✅ Тариф успешно создан.</i>
ntf-plan-deleted-success = <i>✅ Тариф успешно удален.</i>
...
ntf-subscription-plans-not-available = <i>❌ Нет доступных тарифов.</i>
ntf-subscription-gateways-not-available = <i>❌ Нет доступных платежных систем.</i>
ntf-subscription-renew-plan-unavailable = <i>❌ Ваш тариф устарел и не доступен для продления.</i>
...
ntf-broadcast-audience-not-active = <i>❌ Нет пользователей у которых есть АКТИВНАЯ подписка с данным тарифом.</i>
ntf-broadcast-plans-not-available = <i>❌ Нет доступных тарифов.</i>
