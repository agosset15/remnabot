...
event-subscription =
    ...
    *[1] Ваш бесплатный пробный период закончился { unit-day } назад. Оформите подписку, чтобы продолжить пользоваться сервисом!
    ...
    .limited =
    <b>⛔ Внимание! Доступ к LTE-обходу приостановлен.</b>

    Ваш трафик на LTE-обход израсходован. { $is_trial ->
    [0] { $traffic_strategy ->
    ...
    *[1] { $traffic_strategy ->
        [NO_RESET] Оформите подписку, чтобы восстановить трафик.
    ...
    Все сервера кроме LTE-обхода работают без ограничений!
